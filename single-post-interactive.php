...
/*
* Template Name: Interactive Story
...
<style>
  ...
  #tlos-logo a {display:block;width:75px;margin:45px auto;}
  .interactive .entry-header, .entry-summary {text-align: center;}
  .interactive .entry-header h1.entry-title {font-size:48px;font-weight: bold;}
</style>

<div class="container" id="tlos-logo">
  <div class="row">
    <div class="col-sm-12">
      <a href="/" title="Go to website homepage"><img src="https://thelifeofscience.com/wp-content/uploads/2020/06/TLOS-75.png"></a>
    </div>
  </div>
</div>

<div class="container single-template-3 interactive">
  <div class="row">
    <div class="col-sm-12">
